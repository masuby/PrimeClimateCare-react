import "./Hero.css"
import play_icon from "../../Assets/small_play_icon.png"
import pause_icon from "../../Assets/small_pause_icon.png"
const Hero = ({heroData, setHeroCount, 
  heroCount, playStatus, setPlayStatus}) => {
  return (
    <div className="hero">
